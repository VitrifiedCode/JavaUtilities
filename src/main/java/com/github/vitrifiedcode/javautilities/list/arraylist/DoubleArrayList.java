...
public class DoubleArrayList extends AbstractPrimitiveList<Double>
{
    ...
    public boolean contains(final double element) { return indexOf(element) >= 0; }
    ...
    public boolean add(final int index, final double element)
    {
    ...
    public boolean add(final double element) { return add(size, element); }

    @Override
    @Deprecated
    public void add(final int index, final @Nonnull Double element) { add(index, element.doubleValue()); }

    @Override
    @Deprecated
    public boolean add(final @Nonnull Double element) { return add(size, element.doubleValue()); }
    ...
    public double setDouble(final int index, final @Nonnull Double element) { return set(index, element.doubleValue()); }

    @Nonnull
    @Override
    @Deprecated
    public Double set(final int index, final @Nonnull Double element) { return set(index, element.doubleValue()); }

    public double getDouble(final int index) { return elementData[index]; }

    @Nonnull
    @Override
    @Deprecated
    public Double get(final int index) { return getDouble(index); }
    ...
    public int removeDouble(final double element)
    {
    ...
    public int removeDouble(final @Nonnull Double element) { return removeDouble(element.doubleValue()); }

    @Nonnull
    @Override
    @Deprecated
    public Double remove(final int index) { return removeIndex(index); }
}
