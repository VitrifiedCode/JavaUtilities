...
public class IntArrayList extends AbstractPrimitiveList<Integer>
{
    ...
    public boolean contains(final int element) { return indexOf(element) >= 0; }
    ...
    public boolean add(final int element) { return add(size, element); }

    @Override
    @Deprecated
    public void add(final int index, final @Nonnull Integer element) { add(index, element.intValue()); }

    @Override
    @Deprecated
    public boolean add(final @Nonnull Integer element) { return add(size, element.intValue()); }
    ...
    public int setInt(final int index, final @Nonnull Integer element) { return set(index, element.intValue()); }

    @Nonnull
    @Override
    @Deprecated
    public Integer set(final int index, final @Nonnull Integer element) { return set(index, element.intValue()); }

    public int getInt(final int index) { return elementData[index]; }

    @Nonnull
    @Override
    @Deprecated
    public Integer get(final int index) { return getInt(index); }
    ...
    public int removeInt(final int element)
    {
    ...
    public int removeInt(final @Nonnull Integer element) { return removeInt(element.intValue()); }

    @Nonnull
    @Override
    @Deprecated
    public Integer remove(final int index) { return removeIndex(index); }
}
