...
public abstract class AbstractPrimitiveList<E> extends AbstractList<E>
{
    ...
    @Override
    @Deprecated
    public abstract int indexOf(final Object element);

    @Override
    @Deprecated
    public abstract boolean contains(final Object element);

    protected abstract void ensureSize(final int size, final int index);

    protected void ensureSize(final int size) { ensureSize(size, this.size); }
