...
public class BooleanArrayList extends AbstractPrimitiveList<Boolean>
{
    ...
    public boolean contains(final boolean element) { return indexOf(element) >= 0; }
    ...
    public boolean add(final int index, final boolean element)
    {
    ...
    public boolean add(final boolean element) { return add(size, element); }

    @Override
    @Deprecated
    public void add(final int index, final @Nonnull Boolean element) { add(index, element.booleanValue()); }

    @Override
    @Deprecated
    public boolean add(final @Nonnull Boolean element) { return add(size, element.booleanValue()); }
    ...
    public boolean setBoolean(final int index, final @Nonnull Boolean element) { return set(index, element.booleanValue()); }

    @Nonnull
    @Override
    @Deprecated
    public Boolean set(final int index, final @Nonnull Boolean element) { return set(index, element.booleanValue()); }

    public boolean getBoolean(final int index) { return elementData[index]; }

    @Nonnull
    @Override
    @Deprecated
    public Boolean get(final int index) { return getBoolean(index); }
    ...
    public int removeBoolean(final boolean element)
    {
    ...
    public int removeBoolean(final @Nonnull Boolean element) { return removeBoolean(element.booleanValue()); }

    @Nonnull
    @Override
    @Deprecated
    public Boolean remove(final int index) { return removeIndex(index); }
}
