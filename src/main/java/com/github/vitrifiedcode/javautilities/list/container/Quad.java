...
public class Quad<L, ML, MR, R> implements Cloneable
{
    ...
    public Quad(final L left, final ML middleL, final MR middleR, final R right)
    {
        this.left = left;
    ...
    public Quad(final @Nonnull Quad<L, ML, MR, R> other)
    {
        left = other.left;
    ...
    @Nonnull
    @Override
    public Quad<L, ML, MR, R> clone() { return new Quad<>(this); }
